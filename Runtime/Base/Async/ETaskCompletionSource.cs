...
namespace Framework
{
    public class ETaskCompletionSource: ICriticalNotifyCompletion
    {
        ...
        [DebuggerHidden]
        public ETask Task => new ETask(this);
    ...
    public class ETaskCompletionSource<T>: ICriticalNotifyCompletion
    {
        private AwaiterStatus state;
        private T value;
        private ExceptionDispatchInfo exception;
        ...
        [DebuggerHidden]
        public ETask<T> Task => new ETask<T>(this);
