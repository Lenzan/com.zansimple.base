...
namespace Framework
{
    ...
    public class CoroutineLockComponent: Entity
    {
        ...
        public async ETask<CoroutineLock> Wait(CoroutineLockType coroutineLockType, long key)
        {
            ...
            ETaskCompletionSource<CoroutineLock> tcs = new ETaskCompletionSource<CoroutineLock>();
            queue.Enqueue(tcs);
        ...
        public void Notify(CoroutineLockType coroutineLockType, long key)
        {
            ...
            ETaskCompletionSource<CoroutineLock> tcs = queue.Dequeue();
